# Streque API
#
# To require login for an endpoint (should be required most/all endpoints),
...
#     <URL to strequelistan>/api/v1/users/me
#
...
def get_user_by_phone(phone_number):
    user = models.User.query.filter_by(
        phone=util.format_phone_number(phone_number, e164=True)).one()
